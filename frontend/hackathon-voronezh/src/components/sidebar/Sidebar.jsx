                ...
                <CDBSidebarContent className="sidebar-content">
                    <CDBSidebarMenu>
                        <NavLink to={'/calendar'} activeClassName={classes.activeClicked}>
                            <CDBSidebarMenuItem icon="calendar" className={classes.sidebarElement}>Мероприятия</CDBSidebarMenuItem>
                        </NavLink>
                        <NavLink to={'/calendar'} activeClassName={classes.activeClicked}>
                            <CDBSidebarMenuItem icon="chart-line" className={classes.sidebarElement}>Достижения</CDBSidebarMenuItem>
                        </NavLink>
                    </CDBSidebarMenu>
                </CDBSidebarContent>
